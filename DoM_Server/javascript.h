...
void buildJavascript() {
  ...
  javaScript += "        var runtime=document.getElementById('runtime');\n";
  javaScript += "        if(runtime!=undefined){\n";
  ...
  javaScript += "        }\n";
  javaScript += "        var gameMode=document.getElementById('gameMode');\n";
  javaScript += "        if(gameMode!=undefined){\n";
  ...
  javaScript += "        }\n";
  javaScript += "        var hits_1=document.getElementById('hits_1');\n";
  javaScript += "        if(hits_1!=undefined){\n";
  ...
  javaScript += "        }\n";
  javaScript += "        var hits_2=document.getElementById('hits_2');\n";
  javaScript += "        if(hits_2!=undefined){\n";
  ...
  javaScript += "        }\n";
  javaScript += "        var sensetiv=document.getElementById('sensetiv');\n";
  javaScript += "        if(sensetiv!=undefined){\n";
  ...
  javaScript += "        }\n";
  javaScript += "        var duration=document.getElementById('duration');\n";
  javaScript += "        if(duration!=undefined){\n";
